...
void visitorInfo::visitImage(const image_elem& image_el)
{
    ...
    dynamic_cast<QLabel*>(widget)->setPixmap(img.scaledToHeight(300));
    dynamic_cast<QLabel*>(widget)->setAlignment(Qt::AlignCenter);
    widget->setStyleSheet("padding: 0; border: none; background: none;");
